...
namespace lessGravity.Mathematics;
...
public struct BoundingFrustum : IEquatable<BoundingFrustum>
{
    ...
    /// <returns>Type of the containment</returns>
    public readonly bool Contains(ref BoundingFrustum frustum)
    {
    ...
    /// <param name="frustum">The frustum.</param>
    /// <returns>Type of the containment</returns>
    public readonly bool Contains(BoundingFrustum frustum)
    {
    ...
    /// <param name="frustum">The frustum.</param>
    /// <param name="result">Type of the containment.</param>
    public readonly void Contains(ref BoundingFrustum frustum, out bool result)
    {
