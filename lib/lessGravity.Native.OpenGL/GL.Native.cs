...
namespace lessGravity.Native.OpenGL;
...
public static unsafe partial class GL
{
    ...
    {
        _glGetFloativDelegate = (delegate* unmanaged<uint, uint, float*, void>)Glfw.GetProcAddress("glGetFloati_v");
    ...
    {
        _glGetFloativNvDelegate = (delegate* unmanaged<uint, uint, float*, void>)Glfw.GetProcAddress("glGetFloati_vNV");
    ...
    {
        _glGetFloatvDelegate = (delegate* unmanaged<uint, float*, void>)Glfw.GetProcAddress("glGetFloatv");
    ...
    {
        _glTextureParameteriDelegate = (delegate* unmanaged<uint, TextureParameterName, int, void>)Glfw.GetProcAddress(nameof(glTextureParameteri));
    ...
    {
        _glTextureParameterfDelegate = (delegate* unmanaged<uint, TextureParameterName, float, void>)Glfw.GetProcAddress(nameof(glTextureParameterf));
    ...
    private static void glGenerateTextureMipmap(uint texture)
    {
        _generateTextureMipmapDelegate =
            (delegate* unmanaged<uint, void>)Glfw.GetProcAddress(nameof(glGenerateTextureMipmap));
    ...
    private static void glBindBuffer(BufferTarget bufferTarget, uint id)
    {
        _glBindBufferDelegate =
            (delegate* unmanaged<BufferTarget, uint, void>)Glfw.GetProcAddress(nameof(glBindBuffer));
    ...
    private static void glBindBufferBase(BufferTarget bufferTarget, uint slot, uint bufferId)
    {
        _glBindBufferBaseDelegate =
            (delegate* unmanaged<BufferTarget, uint, uint, void>)Glfw.GetProcAddress(nameof(glBindBufferBase));
    ...
    {
        _glBindBufferRangeDelegate = (delegate* unmanaged<BufferTarget, uint, uint, int*, nint, void>)Glfw.GetProcAddress(nameof(glBindBufferRange));
        ...
        uint frameBuffer)
    {
        _glBindFramebufferDelegate =
            (delegate* unmanaged<FramebufferTarget, uint, void>)Glfw.GetProcAddress(nameof(glBindFramebuffer));
    ...
    private static void glBindProgramPipeline(uint pipeline)
    {
        _glBindProgramPipelineDelegate =
            (delegate* unmanaged<uint, void>)Glfw.GetProcAddress(nameof(glBindProgramPipeline));
    ...
    private static void glBindVertexArray(uint vertexArray)
    {
        _glBindVertexArrayDelegate =
            (delegate* unmanaged<uint, void>)Glfw.GetProcAddress(nameof(glBindVertexArray));
    ...
    private static void glBindTexture(TextureTarget target, uint texture)
    {
        _glBindTextureDelegate =
            (delegate* unmanaged<TextureTarget, uint, void>)Glfw.GetProcAddress(nameof(glBindTexture));
    ...
    private static void glActiveTexture(TextureUnit texture)
    {
        _glActiveTextureDelegate =
            (delegate* unmanaged<TextureUnit, void>)Glfw.GetProcAddress(nameof(glActiveTexture));
        ...
        float alpha)
    {
        _glBlendColorDelegate =
            (delegate* unmanaged<float, float, float, float, void>)Glfw.GetProcAddress(nameof(glBlendColor));
    ...
    private static void glBlendEquation(BlendEquationMode mode)
    {
        _glBlendEquationDelegate =
            (delegate* unmanaged<BlendEquationMode, void>)Glfw.GetProcAddress(nameof(glBlendEquation));
        ...
        BlendFactor destinationBlendingFactor)
    {
        _glBlendFuncDelegate =
            (delegate* unmanaged<BlendFactor, BlendFactor, void>)Glfw.GetProcAddress(nameof(glBlendFunc));
        ...
        BlendOperation modeAlpha)
    {
        _glBlendEquationSeparateiDelegate =
            (delegate* unmanaged<uint, BlendOperation, BlendOperation, void>)Glfw.GetProcAddress(
        ...
        BlendFactor destinationAlpha)
    {
        _glBlendFuncSeparateiDelegate =
            (delegate* unmanaged<uint, BlendFactor, BlendFactor, BlendFactor, BlendFactor, void>)Glfw
    ...
    {
        _glClearDelegate = (delegate* unmanaged<FramebufferBit, void>)Glfw.GetProcAddress(nameof(glClear));
        ...
        float alpha)
    {
        _glClearColorDelegate =
            (delegate* unmanaged<float, float, float, float, void>)Glfw.GetProcAddress(nameof(glClearColor));
    ...
    {
        _glClearDepthfDelegate = (delegate* unmanaged<float, void>)Glfw.GetProcAddress(nameof(glClearDepthf));
        ...
        int clearStencil)
    {
        _glClearNamedFramebufferfiDelegate =
            (delegate* unmanaged<uint, Buffer, int, float, int, void>)Glfw.GetProcAddress(
        ...
        float* clearColor)
    {
        _glClearNamedFramebufferfvDelegate =
            (delegate* unmanaged<uint, Buffer, int, float*, void>)Glfw.GetProcAddress(
                nameof(glClearNamedFramebufferfv));
        ...
        int* clearColor)
    {
        _glClearNamedFramebufferivDelegate =
            (delegate* unmanaged<uint, Buffer, int, int*, void>)Glfw.GetProcAddress(
        ...
        uint* clearColor)
    {
        _glClearNamedFramebufferuivDelegate =
            (delegate* unmanaged<uint, Buffer, int, uint*, void>)Glfw.GetProcAddress(
    ...
    {
        _glClearStencilDelegate = (delegate* unmanaged<int, void>)Glfw.GetProcAddress(nameof(glClearStencil));
        ...
        byte alpha)
    {
        _glColorMaskDelegate =
            (delegate* unmanaged<byte, byte, byte, byte, void>)Glfw.GetProcAddress(nameof(glColorMask));
        ...
        byte alpha)
    {
        _glColorMaskiDelegate =
            (delegate* unmanaged<uint, byte, byte, byte, byte, void>)Glfw.GetProcAddress(nameof(glColorMaski));
        ...
        uint* buffers)
    {
        _glCreateBuffersDelegate =
            (delegate* unmanaged<uint, uint*, void>)Glfw.GetProcAddress(nameof(glCreateBuffers));
        ...
        uint* framebuffers)
    {
        _glCreateFramebuffersDelegate =
            (delegate* unmanaged<uint, uint*, void>)Glfw.GetProcAddress(nameof(glCreateFramebuffers));
        ...
        byte** shaderSource)
    {
        _glCreateShaderProgramvDelegate =
            (delegate* unmanaged<ShaderType, uint, byte**, uint>)Glfw.GetProcAddress(nameof(glCreateShaderProgramv));
        ...
        uint* pipelineIds)
    {
        _glCreateProgramPipelinesDelegate =
            (delegate* unmanaged<uint, uint*, void>)Glfw.GetProcAddress(nameof(glCreateProgramPipelines));
        ...
        uint* vertexArrays)
    {
        _glCreateVertexArraysDelegate =
            (delegate* unmanaged<uint, uint*, void>)Glfw.GetProcAddress(nameof(glCreateVertexArrays));
    ...
    {
        _glCullFaceDelegate = (delegate* unmanaged<CullMode, void>)Glfw.GetProcAddress(nameof(glCullFace));
        ...
        uint* buffers)
    {
        _glDeleteBuffersDelegate =
            (delegate* unmanaged<uint, uint*, void>)Glfw.GetProcAddress(nameof(glDeleteBuffers));
        ...
        uint* framebuffers)
    {
        _glDeleteFramebuffersDelegate =
            (delegate* unmanaged<uint, uint*, void>)Glfw.GetProcAddress(nameof(glDeleteFramebuffers));
    ...
    {
        _glDeleteProgramDelegate = (delegate* unmanaged<uint, void>)Glfw.GetProcAddress(nameof(glDeleteProgram));
    ...
    private static void glDeleteProgramPipelines(uint count, uint* pipelines)
    {
        _glDeleteProgramPipelinesDelegate =
            (delegate* unmanaged<uint, uint*, void>)Glfw.GetProcAddress(nameof(glDeleteProgramPipelines));
        ...
        uint* vertexArrays)
    {
        _glDeleteVertexArraysDelegate =
            (delegate* unmanaged<uint, uint*, void>)Glfw.GetProcAddress(nameof(glDeleteVertexArrays));
    ...
    private static void glDeleteTextures(uint count, uint* textures)
    {
        _glDeleteTexturesDelegate =
            (delegate* unmanaged<uint, uint*, void>)Glfw.GetProcAddress(nameof(glDeleteTextures));
    ...
    {
        _glDeleteSamplersDelegate = (delegate* unmanaged<uint, uint*, void>)Glfw.GetProcAddress(nameof(glDeleteSamplers));
    ...
    {
        _glDeleteQueriesDelegate = (delegate* unmanaged<uint, uint*, void>)Glfw.GetProcAddress(nameof(glDeleteQueries));
        ...
        uint* textureIds)
    {
        _glCreateTexturesDelegate =
            (delegate* unmanaged<TextureTarget, uint, uint*, void>)Glfw.GetProcAddress(nameof(glCreateTextures));
    ...
    private static void glDepthFunc(CompareOperation compareOperation)
    {
        _glDepthFuncDelegate =
            (delegate* unmanaged<CompareOperation, void>)Glfw.GetProcAddress(nameof(glDepthFunc));
    ...
    {
        _glDepthMaskDelegate = (delegate* unmanaged<byte, void>)Glfw.GetProcAddress(nameof(glDepthMask));
        ...
        float maxDepth)
    {
        _glDepthRangeDelegate =
            (delegate* unmanaged<float, float, void>)Glfw.GetProcAddress(nameof(glDepthRangef));
    ...
    {
        _glDisableDelegate = (delegate* unmanaged<EnableType, void>)Glfw.GetProcAddress(nameof(glDisable));
        ...
        uint index)
    {
        _glDisableVertexArrayAttribDelegate =
            (delegate* unmanaged<uint, uint, void>)Glfw.GetProcAddress(nameof(glDisableVertexArrayAttrib));
    ...
    private static void glDrawArrays(
        ...
        uint vertexCount)
    {
        _glDrawArraysDelegate = (delegate* unmanaged<PrimitiveType, int, uint, void>)Glfw.GetProcAddress(
            nameof(glDrawArrays));
        ...
        void* indices)
    {
        _glDrawElementsDelegate =
            (delegate* unmanaged<PrimitiveType, int, IndexElementType, void*, void>)Glfw.GetProcAddress(
        ...
        int baseVertex)
    {
        _glDrawElementsBaseVertexDelegate =
            (delegate* unmanaged<PrimitiveType, int, IndexElementType, int, int, void>)Glfw.GetProcAddress(
        ...
        int instanceCount)
    {
        _glDrawElementsInstancedDelegate =
            (delegate* unmanaged<PrimitiveType, int, IndexElementType, void*, int, void>)Glfw.GetProcAddress(
    ...
    private static void glDrawElementsInstancedBaseVertex(
        ...
        int baseVertex)
    {
        _glDrawElementsInstancedBaseVertexDelegate = (delegate* unmanaged<PrimitiveType, int, IndexElementType, void*, int, int, void>)Glfw.GetProcAddress(
    ...
    private static void glDrawElementsInstancedBaseVertexBaseInstance(
        ...
        int baseInstance)
    {
        _glDrawElementsInstancedBaseVertexBaseInstanceDelegate = (delegate* unmanaged<PrimitiveType, int, IndexElementType, void*, int, int, int, void>)Glfw.GetProcAddress(
    ...
    {
        _glDrawArraysInstancedBaseInstanceDelegate =
            (delegate* unmanaged<PrimitiveType, int, int, int, uint, void>)Glfw.GetProcAddress(
    ...
    {
        _glEnableDelegate = (delegate* unmanaged<EnableType, void>)Glfw.GetProcAddress(nameof(glEnable));
        ...
        void* indirect)
    {
        _glDrawElementsIndirectDelegate =
            (delegate* unmanaged<PrimitiveType, IndexElementType, void*, void>)Glfw.GetProcAddress(
        ...
        uint index)
    {
        _glEnableVertexArrayAttribDelegate =
            (delegate* unmanaged<uint, uint, void>)Glfw.GetProcAddress(nameof(glEnableVertexArrayAttrib));
    ...
    {
        _glFrontFaceDelegate = (delegate* unmanaged<FaceWinding, void>)Glfw.GetProcAddress(nameof(glFrontFace));
    ...
    private static void glGenTextures(uint count, uint* textureIds)
    {
        _glGenTexturesDelegate =
            (delegate* unmanaged<uint, uint*, void>)Glfw.GetProcAddress(nameof(glGenTextures));
        ...
        int* values)
    {
        _glGetProgramivDelegate =
            (delegate* unmanaged<uint, ProgramProperty, int*, void>)Glfw.GetProcAddress(
        ...
        nint infoLog)
    {
        _glGetProgramInfoLogDelegate =
            (delegate* unmanaged<uint, uint, int*, nint, void>)Glfw.GetProcAddress(nameof(glGetProgramInfoLog));
    ...
    {
        _glLineWidthDelegate = (delegate* unmanaged<float, void>)Glfw.GetProcAddress(nameof(glLineWidth));
    ...
    {
        _glLogicOpDelegate = (delegate* unmanaged<LogicOperation, void>)Glfw.GetProcAddress(nameof(glLogicOp));
        ...
        BufferStorageMask bufferStorageMask)
    {
        _glNamedBufferStorageDelegate =
            (delegate* unmanaged<uint, long, void*, BufferStorageMask, void>)Glfw.GetProcAddress(
        ...
        BufferUsage bufferUsage)
    {
        _glNamedBufferDataDelegate =
            (delegate* unmanaged<uint, nint, void*, BufferUsage, void>)Glfw.GetProcAddress(
        ...
        void* dataPtr)
    {
        _glNamedBufferSubDataDelegate =
            (delegate* unmanaged<uint, long, long, void*, void>)Glfw.GetProcAddress(nameof(glNamedBufferSubData));
    ...
    private static void glObjectLabel(ObjectIdentifier objectIdentifier, uint id, int length, byte* label)
    {
        _glObjectLabelDelegate =
            (delegate* unmanaged<ObjectIdentifier, uint, int, byte*, void>)Glfw.GetProcAddress(
    ...
    {
        _glPointSizeDelegate = (delegate* unmanaged<float, void>)Glfw.GetProcAddress(nameof(glPointSize));
        ...
        FillMode fillMode)
    {
        _glPolygonModeDelegate =
            (delegate* unmanaged<PolygonModeType, FillMode, void>)Glfw.GetProcAddress(nameof(glPolygonMode));
        ...
        float units)
    {
        _glPolygonOffsetDelegate =
            (delegate* unmanaged<float, float, void>)Glfw.GetProcAddress(nameof(glPolygonOffset));
        ...
        int value)
    {
        _glProgramParameteriDelegate =
            (delegate* unmanaged<uint, ProgramParameterType, int, void>)Glfw.GetProcAddress(
    ...
    {
        _glStencilMaskDelegate = (delegate* unmanaged<byte, void>)Glfw.GetProcAddress(nameof(glStencilMask));
        ...
        uint numLayers)
    {
        _glTextureViewDelegate =
            (delegate* unmanaged<uint, TextureTarget, uint, SizedInternalFormat, uint, uint, uint, uint, void>)Glfw
    ...
    {
        _glUseProgramDelegate = (delegate* unmanaged<uint, void>)Glfw.GetProcAddress(nameof(glUseProgram));
        ...
        uint programId)
    {
        _glUseProgramStagesDelegate =
            (delegate* unmanaged<uint, UseProgramStageMask, uint, void>)Glfw.GetProcAddress(
        ...
        uint bindingIndex)
    {
        _glVertexArrayAttribBindingDelegate =
            (delegate* unmanaged<uint, uint, uint, void>)Glfw.GetProcAddress(
        ...
        uint relativeOffset)
    {
        _glVertexArrayAttribFormatDelegate =
            (delegate* unmanaged<uint, uint, int, DataType, byte, uint, void>)Glfw.GetProcAddress(
        ...
        uint relativeOffset)
    {
        _glVertexArrayAttribIFormatDelegate =
            (delegate* unmanaged<uint, uint, int, DataType, uint, void>)Glfw.GetProcAddress(
    ...
    {
        _glViewportDelegate =
            (delegate* unmanaged<int, int, int, int, void>)Glfw.GetProcAddress(nameof(glViewport));
    ...
    {
        _glScissorDelegate =
            (delegate* unmanaged<int, int, int, int, void>)Glfw.GetProcAddress(nameof(glScissor));
        ...
        void* pixels)
    {
        _glTextureSubImage1DDelegate =
            (delegate* unmanaged<uint, int, int, int, PixelFormat, DataType, void*, void>)Glfw.GetProcAddress(
        ...
        void* pixels)
    {
        _glTextureSubImage2DDelegate =
            (delegate* unmanaged<uint, int, int, int, int, int, PixelFormat, DataType, void*, void>)Glfw
                .GetProcAddress(
        ...
        void* pixels)
    {
        _glTextureSubImage3DDelegate =
            (delegate* unmanaged<uint, int, int, int, int, int, int, int, PixelFormat, DataType, void*, void>)Glfw
                .GetProcAddress(
        ...
        int level)
    {
        _glNamedFramebufferTextureDelegate =
            (delegate* unmanaged<uint, FramebufferAttachment, uint, int, void>)Glfw.GetProcAddress(
        ...
        DrawBuffer* buffers)
    {
        _glNamedFramebufferDrawBuffersDelegate =
            (delegate* unmanaged<uint, uint, DrawBuffer*, void>)Glfw.GetProcAddress(
        ...
        void* userParam)
    {
        _glDebugMessageCallbackDelegate =
            (delegate* unmanaged<nint, void*, void>)Glfw.GetProcAddress(nameof(glDebugMessageCallback));
    ...
    private static void glDebugMessageInsert(
        ...
        byte* message)
    {
        _glDebugMessageInsertDelegate = (delegate* unmanaged<DebugSource, DebugType, uint, DebugSeverity, int, byte*, void>)Glfw.GetProcAddress(nameof(glDebugMessageInsert));
        ...
        int stride)
    {
        _glVertexArrayVertexBufferDelegate =
            (delegate* unmanaged<uint, uint, uint, nint, int, void>)Glfw.GetProcAddress(
        ...
        uint buffer)
    {
        _glVertexArrayElementBufferDelegate =
            (delegate* unmanaged<uint, uint, void>)Glfw.GetProcAddress(nameof(glVertexArrayElementBuffer));
        ...
        byte* message)
    {
        _glPushDebugGroupDelegate =
            (delegate* unmanaged<DebugSource, uint, int, byte*, void>)Glfw.GetProcAddress(
    ...
    {
        _glPopDebugGroupDelegate = (delegate* unmanaged<void>)Glfw.GetProcAddress(nameof(glPopDebugGroup));
        ...
        int indirectDataStride)
    {
        _glMultiDrawElementsIndirectDelegate =
            (delegate* unmanaged<PrimitiveType, IndexElementType, void*, int, int, void>)Glfw.GetProcAddress(
    ...
    private static ulong glGetTextureHandleARB(uint textureId)
    {
        _glGetTextureHandleARBDelegate =
            (delegate* unmanaged<uint, ulong>)Glfw.GetProcAddress(nameof(glGetTextureHandleARB));
        ...
        uint samplerId)
    {
        _glGetTextureSamplerHandleARBDelegate =
            (delegate* unmanaged<uint, uint, ulong>)Glfw.GetProcAddress(nameof(glGetTextureSamplerHandleARB));
    ...
    private static void glMakeTextureHandleResidentARB(ulong handle)
    {
        _glMakeTextureHandleResidentARBDelegate =
            (delegate* unmanaged<ulong, void>)Glfw.GetProcAddress(nameof(glMakeTextureHandleResidentARB));
    ...
    private static void glMakeTextureHandleNonResidentARB(ulong handle)
    {
        _glMakeTextureHandleNonResidentARBDelegate =
            (delegate* unmanaged<ulong, void>)Glfw.GetProcAddress(nameof(glMakeTextureHandleNonResidentARB));
    ...
    private static void glBindTextureUnit(uint unit, uint texture)
    {
        _glBindTextureUnitDelegate =
            (delegate* unmanaged<uint, uint, void>)Glfw.GetProcAddress(nameof(glBindTextureUnit));
        ...
        int width)
    {
        _glTextureStorage1DDelegate =
            (delegate* unmanaged<uint, uint, SizedInternalFormat, int, void>)Glfw.GetProcAddress(
        ...
        int height)
    {
        _glTextureStorage2DDelegate =
            (delegate* unmanaged<uint, uint, SizedInternalFormat, int, int, void>)Glfw.GetProcAddress(
        ...
        int depth)
    {
        _glTextureStorage3DDelegate =
            (delegate* unmanaged<uint, uint, SizedInternalFormat, int, int, int, void>)Glfw.GetProcAddress(
        ...
        uint* samplers)
    {
        _glCreateSamplersDelegate =
            (delegate* unmanaged<int, uint*, void>)Glfw.GetProcAddress(nameof(glCreateSamplers));
        ...
        int param)
    {
        _glSamplerParameteriDelegate =
            (delegate* unmanaged<uint, SamplerParameterI, int, void>)Glfw.GetProcAddress(
        ...
        float parameterValue)
    {
        _glSamplerParameterfDelegate =
            (delegate* unmanaged<uint, SamplerParameterF, float, void>)Glfw.GetProcAddress(
    ...
    {
        _glBindSamplerDelegate = (delegate* unmanaged<uint, uint, void>)Glfw.GetProcAddress(nameof(glBindSampler));
    ...
    {
        _glFinishDelegate = (delegate* unmanaged<void>)Glfw.GetProcAddress(nameof(glFinish));
        _glFinishDelegate();
    }
        ...
        BlitFramebufferFilter filter)
    {
        _glBlitNamedFramebufferDelegate =
            (delegate* unmanaged<uint, uint, int, int, int, int, int, int, int, int, FramebufferBit,
                BlitFramebufferFilter, void>)Glfw.GetProcAddress(nameof(glBlitNamedFramebuffer));
        _glBlitNamedFramebufferDelegate(
            readFramebuffer,
            drawFramebuffer,
            srcX0,
    ...
    {
        _glGetStringDelegate = (delegate* unmanaged<StringName, byte*>)Glfw.GetProcAddress(nameof(glGetString));
    ...
    {
        _glBeginQueryDelegate = (delegate* unmanaged<QueryTarget, int, void>)Glfw.GetProcAddress(nameof(glBeginQuery));
    ...
    {
        _glEndQueryDelegate = (delegate* unmanaged<QueryTarget, void>)Glfw.GetProcAddress(nameof(glEndQuery));
    ...
    {
        _glCreateQueriesDelegate = (delegate* unmanaged<QueryTarget, int, int*, void>)Glfw.GetProcAddress(nameof(glCreateQueries));
    ...
    {
        _glGetQueryObjectuivDelegate = (delegate* unmanaged<int, QueryObjectParameterName, uint*, void>)Glfw.GetProcAddress(nameof(glGetQueryObjectuiv));
    ...
    {
        _glMemoryBarrierDelegate = (delegate* unmanaged<MemoryBarrierMask, void>)Glfw.GetProcAddress(nameof(glMemoryBarrier));
    ...
    {
        _glBindImageTextureDelegate = (delegate* unmanaged<uint, int, int, byte, int, MemoryAccess, SizedInternalFormat, void>)Glfw.GetProcAddress(nameof(glBindImageTexture));
    ...
    private static void glBindImageTextures(
        ...
        int* textures)
    {
        _glBindImageTexturesDelegate = (delegate* unmanaged<uint, int, int*, void>)Glfw.GetProcAddress(nameof(glBindImageTextures));
    ...
    {
        _glDispatchComputeDelegate = (delegate* unmanaged<uint, uint, uint, void>)Glfw.GetProcAddress(nameof(glDispatchCompute));
    ...
    {
        _glDispatchComputeIndirectDelegate = (delegate* unmanaged<nint, void>)Glfw.GetProcAddress(nameof(glDispatchComputeIndirect));
    ...
    {
        _glGetInteger64ivDelegate = (delegate* unmanaged<uint, uint, long*, void>)Glfw.GetProcAddress("glGetInteger64i_v");
    ...
    {
        _glGetInteger64vDelegate = (delegate* unmanaged<uint, long*, void>)Glfw.GetProcAddress("glGetInteger64v");
    ...
    {
        _glGetIntegerivDelegate = (delegate* unmanaged<uint, uint, int*, void>)Glfw.GetProcAddress("glGetIntegeri_v");
    ...
    {
        _glGetIntegerui64ivNvDelegate = (delegate* unmanaged<uint, uint, ulong*, void>)Glfw.GetProcAddress("glGetIntegerui64i_vNV");
    ...
    {
        _glGetIntegerui64vNvDelegate = (delegate* unmanaged<uint, ulong*, void>)Glfw.GetProcAddress("glGetIntegerui64vNV");
    ...
    {
        _glGetIntegervDelegate = (delegate* unmanaged<uint, int*, void>)Glfw.GetProcAddress("glGetIntegerv");
    ...
    {
        _glGetDoubleivDelegate = (delegate* unmanaged<uint, uint, double*, void>)Glfw.GetProcAddress("glGetDoublei_v");
    ...
    {
        _glGetDoublevDelegate = (delegate* unmanaged<uint, double*, void>)Glfw.GetProcAddress("glGetDoublev");
    ...
    {
        _glGetBooleanivDelegate = (delegate* unmanaged<uint, uint, byte*, void>)Glfw.GetProcAddress("glGetBooleani_v");
    ...
    {
        _glGetBooleanvDelegate = (delegate* unmanaged<uint, byte*, void>)Glfw.GetProcAddress("glGetBooleanv");
    ...
    {
        _glGetStringiDelegate = (delegate* unmanaged<uint, uint, byte*>)Glfw.GetProcAddress("glGetStringi");
    ...
    {
        _glMapNamedBufferDelegate = (delegate* unmanaged<int, MemoryAccess, void*>)Glfw.GetProcAddress(nameof(glMapNamedBuffer));
    ...
    {
        _glClipControlDelegate = (delegate* unmanaged<ClipControlOrigin, ClipControlDepth, void>)Glfw.GetProcAddress(nameof(glClipControl));
    ...
    {
        _glGetTextureImageDelegate = (delegate* unmanaged<uint, int, PixelFormat, DataType, int, void*, void>)Glfw.GetProcAddress(nameof(glGetTextureImage));
    ...
    {
        _glProgramUniform1fDelegate = (delegate* unmanaged<int, int, float, void>)Glfw.GetProcAddress(nameof(glProgramUniform1f));
        ...
        int srcDepth)
    {
        _glCopyImageSubDataDelegate =
            ...
            Glfw.GetProcAddress(nameof(glCopyImageSubData));
