...
public sealed class JoltPhysicsWorld : IPhysicsWorld
{
    ...
    private ObjectVsBroadPhaseLayerFilter? _objectVsBroadPhaseLayerFilter;
    private ObjectLayerPairFilter? _objectLayerPairFilter;
    ...
    public bool Load()
    {
        ...
        _objectVsBroadPhaseLayerFilter = new ObjectBroadPhaseFilter();
        _objectLayerPairFilter = new ObjectPairFilter();
        ...
        _physicsSystem.Init(
            ...
            _broadPhaseLayerImplementation, _objectVsBroadPhaseLayerFilter, _objectLayerPairFilter);
